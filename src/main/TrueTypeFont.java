...
public class TrueTypeFont {
    ...
    private int correctL = 7, correctR = 7;
    ...
    private BufferedImage getFontImage(char ch) {
        // Create a temporary image to extract the character's buttonSize
    ...
    private void createSet( char[] customCharsArray ) {
        ...
        // In any case this should be done in other way. Texture with buttonSize 512x512
        // can maintain only 256 characters with resolution of 32x32. The texture
        // buttonSize should be calculated dynamicaly by looking at character sizes.
